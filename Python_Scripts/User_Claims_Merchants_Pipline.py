...
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PaymentLink.Add')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PaymentLink.Edit')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PaymentLink.View')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PaymentLink.Activation')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PaymentLink.InviteCustomer')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PaymentLink.ViewTransactions')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PaymentLink.ViewDetails') 
...
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.Product.Add')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.Product.Edit')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.Product.Activation') 
...
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.IFrame.Add')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.IFrame.Edit')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.IFrame.Delete')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PromoCode.View')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PromoCode.Add')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PromoCode.Edit')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Merchant.PromoCode.Delete')
INSERT into [dbo].[Merchant_Claims] ([user_id], [ClaimType], [ClaimValue]) VALUES (N'{str(id)}', N'permission', N'Permissions.Excelpay.Merchant.Configuration')
